...
if [ -n "$TERMINAL" ]; then
    ...
    echo "Error: No suitable terminal emulator found. Please install one (xrerm, gnome terminal, konsole, kitty or alacritty and create the desktop launcher manually."
fi
